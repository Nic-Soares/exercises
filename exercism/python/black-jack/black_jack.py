...
def is_blackjack(card_one, card_two):
    ...
    first_is_ace = card_one.lower() == "a"
    second_is_ace = card_two.lower() == "a"

    return (
        (first_is_ace and value_of_card(card_two) == 10)
        or (second_is_ace and value_of_card(card_one) == 10)
    )
