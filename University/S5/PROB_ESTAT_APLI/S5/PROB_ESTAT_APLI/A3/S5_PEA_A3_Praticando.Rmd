...
# Plotar os gráficos de densidade para as quatro séries
par(mfrow = c(2, 2))  # Organiza o layout em uma matriz de 2x2
plot(density(serie1), main = "sd = 10", xlab = "Valores", ylab = "Densidade", col = "blue")
plot(density(serie2), main = "sd = 50", xlab = "Valores", ylab = "Densidade", col = "red")
plot(density(serie3), main = "sd = 20", xlab = "Valores", ylab = "Densidade", col = "green")
plot(density(serie4), main = "sd = 5", xlab = "Valores", ylab = "Densidade", col = "orange")

# Plotar os histogramas para as séries com desvio padrão 10 e 20
hist(serie1, main = "Histograma - sd = 10", xlab = "Valores", ylab = "Frequência", col = "blue")
hist(serie3, main = "Histograma - sd = 20", xlab = "Valores", ylab = "Frequência", col = "green")
...
boxplot(DOLAR ~ data, data=df, outlier = TRUE)
```
...
# Plotando o gráfico de caixa sem exibir outliers
boxplot(data_numeric ~ DOLAR, data = df, outlier=FALSE)
