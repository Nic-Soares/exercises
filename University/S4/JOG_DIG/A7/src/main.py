'''
Nesta atividade, você deve baixar o código do jogo papa bolinhas fornecido e executá-lo em sua máquina local, explorando os detalhes do código. Tente, por exemplo, alterar as cores das bolinhas, do papa bolinha; tente alterar a mecânica do jogo em que as bolinhas vermelhas descem do topo da tela para a base da tela.

O código do jogo utilizado no vídeo desta atividade se encontra disponível em:

https://github.com/leobrasil/jolai2018/tree/master/Papa%20bolinhas
'''
